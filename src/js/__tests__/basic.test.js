...
import Bowman from '../class_Bowerman.js';
import Daemon from '../class_Daemon.js';
import Magician from '../class_Magician.js';
import Swordsman from '../class_Swordsman.js';
import Undead from '../class_Undead.js';
import Zombie from '../class_Zombie.js';
...
test('Inflict damage to character', () => {
    const testChar = new Character('Bowy', 'Bowman', 100, 1, 25, 25);
    testChar.damage(50);
